...
public class ArgumentNotValidException extends BaseException{
	...
	public ArgumentNotValidException(ARGUMENT_VALI_EXP ex,Throwable cause){
		super(ex.getCode(),ex.getMessage(),cause);
	}
	
	public ArgumentNotValidException(ARGUMENT_VALI_EXP ex){
		super(ex.getCode(),ex.getMessage());
	}
	
	public ArgumentNotValidException(int code,String message){
		super(code,message);
	}
