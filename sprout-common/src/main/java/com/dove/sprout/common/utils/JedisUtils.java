/**
 * Copyright http://blog.csdn.net/qq7342272/article/details/49299787
 */
...
public class JedisUtils {
	 ...
	 private static final Logger LOGGER = LoggerFactory.getLogger(JedisUtils.class);  
	    ...
	    private static JedisUtils jedis = new JedisUtils();  
	    ...
	    * @author bod     
	    ...
	    public static Long ttlObj(Object key){
	    	return ttl(BeanUtil.serialize(key));
	    }
	     ...
	     * 根据对象key获取对象value
	     * @author bod
	     * 2017年4月26日上午11:31:33
	     */
	    public static Object getObj(Object key){
	    	byte[] value = get(BeanUtil.serialize(key));
	    	return BeanUtil.unserialize(value);
	    }
	    
	    /**
	     * 根据字节key获取字节value
	     * @author bod
	     * 2017年4月26日上午11:31:55
	     */
	     ...
	     * 设置对象存储 + 缓存时间
	     * @author bod
	     * 2017年4月26日上午11:25:43
	     */
	    public static void setObj(Object key,Object value,int exp){
	    	set(BeanUtil.serialize(key),BeanUtil.serialize(value),exp);
	    }
	    
	    /**
	     * 设置 字节存储 
	     * @author bod
	     * 2017年4月26日上午11:26:36
	     */
	 ...
	 /*   public boolean del(Object key){
	    	Long flag = del(BeanUtil.serialize(key));
	     ...
	     * @return 
	     */  
	    static synchronized public String lpop(String key){  
	        Jedis jedis = null;  
	        String res = null;  
	        try {  
	            jedis = pool.getResource();  
	    ...
	    public static JedisUtils getJedis() {  
	        return jedis;  
	    }  
	  
	    public static void setJedis(JedisUtils jedis) {  
	        JedisUtils.jedis = jedis;  
	    }  
